...
Song song với dialogue/demo.py nhưng thay MockRetriever bằng RealKISCRetriever
(chạy trên KeyframeIndex/CoarseRetriever thật). Đặt ở retrieval/ để KHÔNG phải sửa
dialogue/demo.py (tôn trọng Mục 10.6). Cùng kịch bản case-study slide 15 -> kiểm
chứng vòng hội thoại KISC hội tụ đúng trên hạ tầng retrieval thật.

Chạy: python -m retrieval.dialogue_real_demo
"""
from __future__ import annotations

from dialogue.dialogue_manager import KISCDialogueManager
from retrieval.dialogue_adapter import RealKISCRetriever, build_sample_index
