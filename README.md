...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-283%20passing-2f9e6f" alt="Tests">
...
| ✅ **283 unit test** | `pytest` chạy hoàn toàn offline (~7s) — không cần GPU/API key |
...
pytest                            # → 283 passed (~7s, không cần GPU)
...
<p align="center">
  <sub>Chạy offline bằng mock · cắm model/API thật là dùng · 283 test xanh</sub>
</p>
