...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-282%20passing-2f9e6f" alt="Tests">
...
| ✅ **282 unit test** | `pytest` chạy hoàn toàn offline (~7s) — không cần GPU/API key |
...
pytest                            # → 282 passed (~7s, không cần GPU)
...
<p align="center">
  <sub>Chạy offline bằng mock · cắm model/API thật là dùng · 282 test xanh</sub>
</p>
